    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ...
            MainPhone = table.Column<string>(type: "longtext", nullable: true)
                  .Annotation("MySql:CharSet", "utf8mb4"),
            Phones = table.Column<string>(type: "longtext", nullable: true)
                  .Annotation("MySql:CharSet", "utf8mb4"),
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            Id = table.Column<int>(type: "int", nullable: false)
                  .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
            IsHandOfTheDeadActive = table.Column<bool>(type: "tinyint(1)", nullable: true),
            Name = table.Column<string>(type: "longtext", nullable: true)
                  .Annotation("MySql:CharSet", "utf8mb4")
          },
          constraints: table =>
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            Id = table.Column<int>(type: "int", nullable: false)
                  .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
            VisitStart = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            VisitEnd = table.Column<DateTime>(type: "datetime(6)", nullable: false),
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ...
            City = table.Column<string>(type: "longtext", nullable: true)
                  .Annotation("MySql:CharSet", "utf8mb4"),
            CityType = table.Column<string>(type: "longtext", nullable: true)
                  .Annotation("MySql:CharSet", "utf8mb4"),
          ...
          constraints: table =>
          {
            ...
            table.ForeignKey(
                      name: "FK_Address_Contacts_ParentId",
                      column: x => x.ParentId,
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            ...
            table.ForeignKey(
                      name: "FK_ContentBlock_Pages_ParentId",
                      column: x => x.ParentId,
                      principalTable: "Pages",
                      principalColumn: "Id");
          })
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            ...
            table.ForeignKey(
                      name: "FK_Organization_Contacts_ContactsId",
                      column: x => x.ContactsId,
                      principalTable: "Contacts",
                      principalColumn: "Id");
            table.ForeignKey(
                      name: "FK_Organization_Files_LogoId",
                      column: x => x.LogoId,
                      principalTable: "Files",
                      principalColumn: "Id");
            table.ForeignKey(
                      name: "FK_Organization_Settings_ParentId",
                      column: x => x.ParentId,
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ...
            ShowNavigation = table.Column<bool>(type: "tinyint(1)", nullable: false),
            Name = table.Column<string>(type: "longtext", nullable: true)
                  .Annotation("MySql:CharSet", "utf8mb4")
          },
          constraints: table =>
          {
            ...
            table.ForeignKey(
                      name: "FK_PortalSettings_Settings_SettingsId",
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            ...
            table.ForeignKey(
                      name: "FK_BlockType_ContentBlock_ParentId",
                      column: x => x.ParentId,
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            Id = table.Column<int>(type: "int", nullable: false)
                  .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
            CssPath = table.Column<string>(type: "longtext", nullable: false)
                  .Annotation("MySql:CharSet", "utf8mb4"),
            IsSelected = table.Column<bool>(type: "tinyint(1)", nullable: false),
            PortalSettingsId = table.Column<int>(type: "int", nullable: true),
            Name = table.Column<string>(type: "longtext", nullable: true)
                  .Annotation("MySql:CharSet", "utf8mb4")
          },
          constraints: table =>
          {
            ...
            table.ForeignKey(
                      name: "FK_Theme_PortalSettings_PortalSettingsId",
                      column: x => x.PortalSettingsId,
      ...
      migrationBuilder.CreateIndex(
          name: "IX_BlockType_ParentId",
          table: "BlockType",
          column: "ParentId",
          unique: true);

      migrationBuilder.CreateIndex(
          name: "IX_ContentBlock_ParentId",
          table: "ContentBlock",
          column: "ParentId");

      migrationBuilder.CreateIndex(
          name: "IX_Organization_ContactsId",
          table: "Organization",
          column: "ContactsId");
      ...
      migrationBuilder.CreateIndex(
          name: "IX_PortalSettings_SettingsId",
          table: "PortalSettings",
          column: "SettingsId",
          unique: true);

      migrationBuilder.CreateIndex(
          name: "IX_Theme_PortalSettingsId",
          table: "Theme",
          column: "PortalSettingsId");
    }
